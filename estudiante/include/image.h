...
public :
    ...
    /**
      @brief Iterador Imagen

      Iterador para recorrer los píxeles de una imagen de forma secuencial
    ...
    **/
    ...
    /**
      * @brief Iterador para recorrer los píxeles de una imagen
      * @return Iterador en la posición inicial
      */
    Iterator begin();

    /**
      * @brief Fin del iterador para recorrer los píxeles de una imagen
      * @return Iterador fuera de la imagen que indica el final
      */
    Iterator end();
} ;
